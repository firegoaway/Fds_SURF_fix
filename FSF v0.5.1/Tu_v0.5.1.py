...
def main(page: ft.Page):
    page.title = "Расчёт времени активации спринклера v0.5.1"
    ...
    def generate_plot(e):
        ...
        ax2 = ax1.twinx()
        ax2.set_ylabel('Температура газов [°C]', color='black')
        ...
        legend = ax1.legend(lines + lines2, labels + labels2, loc='lower right', labelcolor='black', prop={'size': 8})
