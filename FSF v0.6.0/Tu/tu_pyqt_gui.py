...
class SprinklerCalcApp(QMainWindow):
    def __init__(self):
        ...
        self.setMinimumSize(1280, 800) # Match original Flet window size
    ...
    def _setup_ui(self):
        ...
        # Use QScrollArea for the left widget to make it scrollable
        ...
        left_layout_container = QVBoxLayout() # Container for scroll area itself
        left_layout_container.addWidget(scroll_area)
        left_layout_container.setContentsMargins(0,0,0,0)

        header_label = QLabel("Введите значения\nпеременных")
        header_label.setStyleSheet("font-size: 14px; font-weight: bold; color: #0284c7;")
        left_layout.addWidget(header_label)

        # Input Fields with Labels
        self._create_input_field(left_layout, "Fpom_input", "Fpom", "500", "Площадь помещения с очагом пожара, м²")
        ...
        right_layout = QFormLayout(right_widget) # Use QFormLayout for output fields too
        ...
        result_heading.setStyleSheet("font-size: 14px; font-weight: bold; color: #0284c7;")
        ...
        right_layout.addStretch(1) # Push outputs to top
