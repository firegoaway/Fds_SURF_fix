...
class FDSProcessorAppQt(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        input_layout.addWidget(self.k_entry[0]) # QLineEdit for k
        input_layout.addWidget(self.fpom_entry[0]) # QLineEdit for Fпом
        input_layout.addWidget(self.v_entry[0]) # QLineEdit for v
        input_layout.addWidget(self.psyd_entry[0]) # QLineEdit for ψуд
        input_layout.addWidget(self.m_entry[0]) # QLineEdit for m
        input_layout.addWidget(self.t_entry[0]) # QLineEdit for t
